...
Tools ... "                                                     sleep 1
echo ""
echo  $white"[#]> Babacang07
Here ... "
read enter
exit
}
=================================================
echo $white"Author : all team KBCI official"
echo $white"Team : Keluarga Besar Cyber Islam"
echo $white"Thanks To :Mr.Balckhat| Mr.Sans| Mr.White wolf tersakiti | Mr.Razzor.17
echo $white"Github :https://github.com/Babacang07"
echo $white"Youtube : FTV"
=================================================
...
echo  $yellow" 09) Youtube Dl"                                  echo  $yellow" 10) viSQL "
...
apt install wget
wget
https://raw.githubusercontent.com/verluchie/termux-metasploit/master/>
...
sleep 1
echo  $white" Inviet Kode :2bk340dk94 | Inviet Kode 154d955b9 |Inviet>
echo  $red" Masukin Kode Itu Ke Rendemm Pulsa Kalian ^_^"
exit
fi
                                                                      if [ $bro = 08 ] || [ $bro = 8 ]then
clear
...
sleep 1
echo  $white" Name:Lita |Number Card : 2748074115574 Exp 2-2024 | Nam>
echo  $red" Bila Ingin Lebih Lanjut Tunggu Peng Update an Selanjut ny>
exit
fi

if [ $bro = 15 ] || [ $bro = 15 ]
then
echo " Thanks to KBCI team official "
sleep 1
echo " Sangat Gans"
sleep 1
echo " Bay-Bay "
...
sleep 1
echo " Tobat bro seblum terlambat :)"
sleep 1
exit
fi
